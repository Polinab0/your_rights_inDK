...
<main class="inner-page">
    ...
    <div class="help-section__container">
        ...
        <div class="help-section__header">
            ...
            <img src="<?php echo esc_url(get_field('help_icon')); ?>" alt="Help icon">

            <h2>
                <?php echo esc_html(get_field('help_title')); ?>
            </h2>

        </div>

        <div class="help-section__text">
            <?php echo wp_kses_post(get_field('help_text')); ?>
        </div>
